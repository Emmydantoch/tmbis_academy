    ...
    <div className="min-h-screen bg-background text-on-surface flex">
      ...
      <nav className="hidden md:flex w-64 flex-col h-screen bg-surface-container-low border-r border-outline-variant fixed left-0 top-0 z-20 p-4">
        ...
        <div className="flex-1 space-y-1">
          ...
          <NavItem icon="account_balance_wallet" label="Payments" active />
        </div>
      ...
      <div className="flex-1 md:ml-64">
        <header className="h-16 bg-surface/80 backdrop-blur-md border-b border-outline-variant flex items-center px-6 sticky top-0 z-10">
